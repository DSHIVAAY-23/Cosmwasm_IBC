...
pub fn do_ibc_packet_receive(
    ...
    match msg {
        IbcExecuteMsg::SendContractAddress {} => execute_send_contract_address(deps,env, channel),
    }
}

pub fn execute_send_contract_address(
    deps: DepsMut,
    env: Env,
    channel: String,
) -> Result<IbcReceiveResponse, ContractError> {
    ...
    Ok(IbcReceiveResponse::new()
        .add_attribute("method", "execute_send_contract_address")
        .add_attribute("count", count.to_string())
        .set_ack(make_ack_success(env.contract.address)))
}
